const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_shell-w3x3hXO6.js","./sheet-B6Cmoxvh.js","./button-DGo68xNG.js","./select-cz2npUlP.js","./progress-DRd_MjCP.js","./alert-dialog-CTCtlElL.js","./settings-BVUuLTNg.js","./_shell.index-Db4PLIkq.js","./search-CchuWvBb.js","./_shell.downloads-DoD7UB_m.js","./_shell.config-editor-BKTg9ttI.js"])))=>i.map(i=>d[i]);
  ...
  if (!route._componentsLoaded && route._componentsPromise === void 0) {
    const loadComponents = () => {
      ...
      for (const type of componentTypes) {
        const preload2 = route.options[type]?.preload;
...
function Transitioner() {
  ...
  reactExports.useEffect(() => {
    const unsub = router2.history.subscribe(
      ({ navigateOpts }) => {
...
const $$splitComponentImporter$3 = () => __vitePreload(() => import("./_shell-w3x3hXO6.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url);
const Route$3 = createFileRoute("/_shell")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => __vitePreload(() => import("./_shell.index-Db4PLIkq.js"), true ? __vite__mapDeps([7,1,2,3,4,8]) : void 0, import.meta.url);
const Route$2 = createFileRoute("/_shell/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => __vitePreload(() => import("./_shell.downloads-DoD7UB_m.js"), true ? __vite__mapDeps([9,2,4,6]) : void 0, import.meta.url);
const Route$1 = createFileRoute("/_shell/downloads")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => __vitePreload(() => import("./_shell.config-editor-BKTg9ttI.js"), true ? __vite__mapDeps([10,2,3,5,8]) : void 0, import.meta.url);
const Route2 = createFileRoute("/_shell/config-editor")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ShellRoute = Route$3.update({
  id: "/_shell",
  getParentRoute: () => Route$4
});
const ShellIndexRoute = Route$2.update({
  id: "/",
  path: "/",
  getParentRoute: () => ShellRoute
});
const ShellDownloadsRoute = Route$1.update({
  id: "/downloads",
  path: "/downloads",
  getParentRoute: () => ShellRoute
});
const ShellConfigEditorRoute = Route2.update({
  id: "/config-editor",
  path: "/config-editor",
  getParentRoute: () => ShellRoute
});
const ShellRouteChildren = {
  ShellConfigEditorRoute,
  ShellDownloadsRoute,
  ShellIndexRoute
};
...
function useStore(api, selector = identity) {
  const slice = We.useSyncExternalStore(
    api.subscribe,
    We.useCallback(() => selector(api.getState()), [api, selector]),
    We.useCallback(() => selector(api.getInitialState()), [api, selector])
  );
  We.useDebugValue(slice);
  return slice;
}
...
const useGameManagementStore = create()(
  persist(
    (set) => ({
      // Initial state
      ...
      // Actions
      addManagedGame: (gameId) => set((state) => {
      ...
      appendRecentManagedGame: (gameId) => set((state) => {
...
const useProfileStore = create()(
  persist(
    (set, get) => ({
      ...
      // Actions
      setActiveProfile: (gameId, profileId) => set((state) => ({
        activeProfileIdByGame: {
...
reactExports.lazy(
  () => __vitePreload(() => import("./index-Q9IX870k.js"), true ? [] : void 0, import.meta.url).then((m) => ({
...
clientExports.createRoot(rootEl).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppBootstrap, {}),
