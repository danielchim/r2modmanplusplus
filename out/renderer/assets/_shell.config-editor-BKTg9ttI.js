const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Dx3wuTxZ.js","./index-D84i-0IV.js","./index-CszVia_H.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxRuntimeExports, _ as __vitePreload } from "./index-D84i-0IV.js";
import { c as createLucideIcon, a as cn, B as Button, L as LoaderCircle } from "./button-DGo68xNG.js";
import { I as Input, C as ChevronDown, D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, h as DropdownMenuItem, aH as ExternalLink, T as Trash2, U as Switch, V as Select, W as SelectTrigger, X as SelectValue, Y as SelectContent, Z as SelectItem } from "./select-cz2npUlP.js";
import { i as FileCode, F as FolderOpen, A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-CTCtlElL.js";
import { S as Search, E as EllipsisVertical } from "./search-CchuWvBb.js";
...
const MonacoEditor = reactExports.lazy(() => __vitePreload(() => import("./index-Dx3wuTxZ.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url));
const CONFIG_DOCS = [
